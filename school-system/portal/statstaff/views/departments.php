<?php
// portal/statstaff/views/departments.php
...
<div class="container my-5">
    ...
    <h2 class="fw-bold mb-4">View Departments</h2>
    <table class="table table-striped shadow-sm">
        <thead class="table-light">
            <tr><th>Dept ID</th><th>Dept Name</th></tr>
        </thead>
        <tbody>
            <?php foreach ($data as $d): ?>
                <tr>
                    <td><?= htmlspecialchars($d['departmentID']) ?></td>
