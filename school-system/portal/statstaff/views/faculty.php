<?php
// portal/statstaff/views/faculty.php
...
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div style="width: 300px;">
            <input type="text" id="statFacultySearch" class="form-control" placeholder="Search faculty...">
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <table class="table table-hover mb-0">
            <thead class="table-light">
                <tr><th>ID</th><th>Name</th><th>Email</th><th>Rank</th></tr>
            </thead>
...
<script>
    document.getElementById('statFacultySearch').addEventListener('input', function(e) {
