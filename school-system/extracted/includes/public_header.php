            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="navbar-nav ms-auto">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        <a class="nav-link btn btn-primary text-white px-3 ms-lg-3" href="/portal/<?= strtolower($_SESSION['user_type']) ?>/index.php">Dashboard</a>
                        <a class="nav-link" href="/public/logout.php">Logout</a>
                    <?php else: ?>
                        <a class="nav-link" href="/public/login.php">Login</a>
                        <a class="nav-link btn btn-primary text-white px-4 ms-lg-3" href="/public/register.php">Apply Now</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
